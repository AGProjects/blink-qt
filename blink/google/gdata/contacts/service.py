...
class ContactsService(gdata_service.GDataService):
  ...
  def __init__(self, email=None, password=None, source=None,
    ...
    Args:
      ...
      **kwargs: The other parameters to pass to gdata_service.GDataService
          constructor.
    """

    self.contact_list = contact_list
    gdata_service.GDataService.__init__(
...
class ContactsQuery(gdata_service.Query):
  ...
  def __init__(self, feed=None, text_query=None, params=None,
    ...
    gdata_service.Query.__init__(self, feed=self.feed, text_query=text_query,
...
class GroupsQuery(gdata_service.Query):
...
class ProfilesQuery(gdata_service.Query):
