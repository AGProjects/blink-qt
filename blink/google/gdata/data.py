...
from blink.google.atom import core as atom_core, data as atom_data
...
class ExtendedProperty(atom_core.XmlElement):
  ...
  def get_xml_blob(self):
    """Returns the XML blob as an atom_core.XmlElement.
...
class BatchInterrupted(atom_core.XmlElement):
...
class EntryLink(atom_core.XmlElement):
...
class FeedLink(atom_core.XmlElement):
...
class AdditionalName(atom_core.XmlElement):
...
class Comments(atom_core.XmlElement):
...
class EmailImParent(atom_core.XmlElement):
  address = 'address'
  label = 'label'
  rel = 'rel'
  primary = 'primary'
...
class FamilyName(atom_core.XmlElement):
...
class GivenName(atom_core.XmlElement):
...
class NamePrefix(atom_core.XmlElement):
...
class NameSuffix(atom_core.XmlElement):
...
class FullName(atom_core.XmlElement):
...
class OrgDepartment(atom_core.XmlElement):
...
class OrgJobDescription(atom_core.XmlElement):
...
class OrgName(atom_core.XmlElement):
...
class OrgSymbol(atom_core.XmlElement):
...
class OrgTitle(atom_core.XmlElement):
...
class Organization(atom_core.XmlElement):
...
class When(atom_core.XmlElement):
  """The gd:when element.
...
class OriginalEvent(atom_core.XmlElement):
...
class PhoneNumber(atom_core.XmlElement):
...
class PostalAddress(atom_core.XmlElement):
...
class Rating(atom_core.XmlElement):
...
class Recurrence(atom_core.XmlElement):
...
class RecurrenceException(atom_core.XmlElement):
...
class Reminder(atom_core.XmlElement):
...
class Agent(atom_core.XmlElement):
...
class Postcode(atom_core.XmlElement):
...
class FormattedAddress(atom_core.XmlElement):
...
class StructuredPostalAddress(atom_core.XmlElement):
...
class Where(atom_core.XmlElement):
...
class Money(atom_core.XmlElement):
  """Describes money"""
